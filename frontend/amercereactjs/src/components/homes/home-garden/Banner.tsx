          ...
          <div className="banner-image-text style-top-left tl-2">
            <Link to={`/shop-default`} className="bn-image img-style rounded-0">
              <img
                ...
                width={640}
                height={954}
                src="/frontend/assets/images/section/banner-49.jpg"
                alt="Image"
              />
            </Link>
            ...
            <div className="banner-image-text type-abs style-20">
              <Link to={`/shop-default`} className="bn-image img-style">
                <img
                  ...
                  width={450}
                  height={608}
                  src="/frontend/assets/images/section/banner-50.jpg"
                  alt="Image"
                />
              </Link>
            ...
            <div className="banner-image-text type-abs style-20">
              <Link to={`/shop-default`} className="bn-image img-style">
                <img
                  ...
                  width={450}
                  height={608}
                  src="/frontend/assets/images/section/banner-51.jpg"
                  alt="Image"
                />
              </Link>
              <div className="bn-content wow fadeInUp">
          ...
          <div className="banner-image-text type-abs style-19">
            <Link to={`/shop-default`} className="bn-image img-style">
              <img
                ...
                width={450}
                height={608}
                src="/frontend/assets/images/section/banner-52.jpg"
                alt="Image"
              />
            </Link>
            <div className="bn-content wow fadeInUp">
