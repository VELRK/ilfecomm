            ...
            <div className="box-image_v07 hover-img">
              <Link to={`/shop-default`} className="box-image_img img-style">
                <img
                  ...
                  width={690}
                  height={922}
                  src="/frontend/assets/images/collection/bag/cls-1.jpg"
                  alt="Image"
                />
              </Link>
              ...
              <div className="box-cls-v1 style-2 hover-img">
                <Link to={`/shop-default`} className="cls-image img-style">
                  <img
                    ...
                    width={690}
                    height={446}
                    src="/frontend/assets/images/collection/bag/cls-2.jpg"
                    alt="Image"
                  />
                </Link>
              ...
              <div className="box-cls-v1 hover-img">
                <Link to={`/shop-default`} className="cls-image img-style">
                  <img
                    ...
                    width={690}
                    height={446}
                    src="/frontend/assets/images/collection/bag/cls-3.jpg"
                    alt="Image"
                  />
                </Link>
                <div className="cls-content wow fadeInUp">
