          ...
          <div className="category-v07 hover-img4">
            <Link to={`/shop-default`} className="cate-image img-style4 mb-15">
              <img
                ...
                width={457}
                height={320}
                src="/ecomm/frontend/assets/images/collection/cls-27.jpg"
                alt="Image"
              />
            </Link>
          ...
          <div className="category-v07 hover-img4">
            <Link to={`/shop-default`} className="cate-image img-style4 mb-15">
              <img
                ...
                width={457}
                height={320}
                src="/ecomm/frontend/assets/images/collection/cls-28.jpg"
                alt="Image"
              />
            </Link>
            <div className="cate-content">
          ...
          <div className="category-v07 hover-img4">
            <Link to={`/shop-default`} className="cate-image img-style4 mb-15">
              <img
                ...
                width={457}
                height={320}
                src="/ecomm/frontend/assets/images/collection/cls-29.jpg"
                alt="Image"
              />
            </Link>
            <div className="cate-content">
